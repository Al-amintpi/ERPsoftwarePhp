 ...
 <div class="card-box mb-30">
	<div class="pd-20">
		<h6 class="text-blue h4">
			<b><?php echo singleAttUserAll($user_id,"user_name"); ?></b>  <small>Current-Month-All-Over-Time</small></h6>
	</div>
	<div class="pb-20">
			...
			<tbody>
				<?php 
					...
					for($i=$start_date; $i<=$current_date; $i++){
						...
						if(currentMonthAllOverTime($user_id,$checkattdate)==1):
				...
				<tr>
					...
					<td><?php echo overTimeUserAll($user_id,"n_of_hour"); ?>min</td>
					<td><?php echo overTimeUserAll($user_id,"rate"); ?>Tk</td>
					<td><?php echo overTimeUserAll($user_id,"overtime_totalTk"); ?>Tk</td>
